...
class CloudSpannerQueryGenerator extends AbstractQueryGenerator {
  ...
  createTableQuery(tableName, attributes, options) {
    ...
    if (pkString.length > 0) {
      primaryKeyClause = ` PRIMARY KEY (${pkString})`;
    }
  ...
  //     identifier.includes('.') ||
  //     identifier.includes('->') ||
  //     CLOUD_SPANNER_RESERVED_WORDS.includes(rawIdentifier.toUpperCase())
  //   ) {
...
module.exports = CloudSpannerQueryGenerator;
