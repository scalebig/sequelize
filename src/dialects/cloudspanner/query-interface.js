...
/**
 * The interface that Sequelize uses to talk with Cloud Spanner database
 */
class CloudSpannerQueryInterface extends QueryInterface {
  /**
...
exports.CloudSpannerQueryInterface = CloudSpannerQueryInterface;
